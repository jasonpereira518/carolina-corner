...
export default function UserInfoPage() {
  ...
  const [firstName, setFirstName] = useState(session.userProfile?.firstName ?? "");
  const [onyen, setOnyen] = useState(session.userProfile?.onyen ?? "");
  const [email, setEmail] = useState(session.userProfile?.email ?? "");
